...
export const navigationItems = [
  ...
  { id: "putaway", label: "Putaway", icon: Forklift, permission: "putaway.view", href: "/putaway" },
  ...
  { id: "orders", label: "Orders", icon: PackageCheck, permission: "order-fulfillment.view", href: "/order-fulfillment" },
  { id: "dispatch", label: "Dispatch", icon: Truck, permission: "dispatch.view", href: "/dispatch" },
  { id: "returns", label: "Returns", icon: RotateCcw, permission: "returns.view", href: "/returns" },
